...
VALUES('muster@itfox.at', HASHBYTES('sha512', '123user!'), 'Max', 'Muster', 0, 1, 0043676123456);
INSERT INTO Benutzer(email, passwort, vorname, nachname, geschlecht, adresse_id, telefon)
VALUES('marco@itfox.at', HASHBYTES('sha512', '123user!'), 'Marco', 'Wurz', 0, 2, 0049743212121);
INSERT INTO Benutzer(email, passwort, vorname, nachname, geschlecht, adresse_id, telefon)
VALUES('claudia@itfox.at', HASHBYTES('sha512', '123user!'), 'Claudia', 'Stiegl', 1, 3, 003256124565);
INSERT INTO Benutzer(email, passwort, vorname, nachname, geschlecht, adresse_id, telefon)
VALUES('daniel@itfox.at', HASHBYTES('sha512', '123user!'), 'Daniel', 'Zalli', 0, 4, 00396123456);
INSERT INTO Benutzer(email, passwort, vorname, nachname, geschlecht, adresse_id, telefon)
VALUES('stefan@itfox.at', HASHBYTES('sha512', '123user!'), 'Stefan', 'Groig', 0, 5, 0055236458);
