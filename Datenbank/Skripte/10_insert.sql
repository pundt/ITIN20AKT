...
VALUES('Wandern in den Bergen', 'Erleben Sie die schöne Bergwelt in Österreich', 4, 65.99, 32.99,1);
INSERT INTO Reise(titel, beschreibung, unterkunft_id, preis_erwachsener, preis_kind, ort_id)
VALUES('Wellnes pur', 'Genießen Sie italienische Luft und Wellnes vom Feinsten', 1, 150.00, 75.00,2);
INSERT INTO Reise(titel, beschreibung, unterkunft_id, preis_erwachsener, preis_kind, ort_id)
VALUES('Fußball pur', 'Fahren Sie zum EM-Finale nach Paris!', 2, 199.99, 99.99,3);
INSERT INTO Reise(titel, beschreibung, unterkunft_id, preis_erwachsener, preis_kind,ort_id)
